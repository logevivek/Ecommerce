    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        ...
        {{-- Add Coupon Code Here --}}
          <li class="nav-item has-treeview {{ request()->is('coupons', 'addcoupons', 'editCoupons') ? 'menu-open' : '' }}">
            <a href="#" class="nav-link {{ request()->is('coupons', 'addcoupons', 'editCoupons') ? 'active' : '' }}">
                <i class="nav-icon fa fa fa-gift"></i>
                <p>
                    Manage Coupon Code
                    <i class="right fas fa-angle-left"></i>
                </p>
            ...
            <ul class="nav nav-treeview">
                <li class="nav-item">
                    <a href="{{ url('/coupons') }}" class="nav-link {{ request()->is('coupons', 'editCoupons') ? 'active' : '' }}">
                        <i class="far fa-circle nav-icon"></i>
                        <p>Show Coupons</p>
                    </a>
                </li>
                <li class="nav-item">
                    <a href="{{ url('/addcoupons') }}" class="nav-link {{ request()->is('addcoupons') ? 'active' : '' }}">
                        <i class="far fa-circle nav-icon"></i>
                        <p>Add Coupon</p>
                    </a>
                </li>
