            ...
            <div class="container-fluid">
              <div class="row">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="/storepage" method="post" id="pageForm">
                            @csrf
                            ...
                            <br>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <textarea type="text" name="desc" id="desc" rows="3" class="form-control"> {{{ old('desc') }}} </textarea>
                            ...
                            <fieldset class="border p-3 rounded">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <textarea type="text" name="meta_description" id="meta_description" rows="2" class="form-control">{{{ old('meta_description') }}}</textarea>
